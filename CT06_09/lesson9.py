...
# num1 = int(input("What number from 1 to 10 do you think it is? "))
# if num == num1:
...
for count in range(7):
    ...
    if daytemp >= 30:
        hotday = hotday + 1
print("The amount of days that you recorded a tempreture over 30 degrees in this week is", hotday +". ")